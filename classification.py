...
max_dep = [1, 2, 3, 4, 5, 6, 7, 10]
max_features = [4, 5, 6, 7, 8, 9]
c = [0.000000000000000001, 1, 10, 100, 150]
# bestParameters(X_train, y_train, DecisionTreeClassifier, "max_depth", max_dep, "max_features", -1)
# bestParameters(X_train, y_train, DecisionTreeClassifier, "max_features", max_features, "max_depth", 5)
...
model5 = DecisionTreeClassifier(max_depth=5, max_features=6).fit(X_train, y_train)
